...
/*!
 Get all the channels that this device is subscribed to. Raises an exception
 if the current PFInstallation object is dirty.
 @param error Pointer to an NSError that will be set if necessary.
...
/*!
 Asynchronously get all the channels that this device is subscribed to. Raises
 an exception if the current PFInstallation object is dirty.
 @param target The object to call selector on.
...
/*!
 Subscribes the device to a channel of push notifications. Raises an exception
 if the current PFInstallation object is dirty.
...
/*!
 Asynchronously subscribes the device to a channel of push notifications. Raises
 an exception if the current PFInstallation object is dirty.
 @param channel The channel to subscribe to. The channel name must start with
 a letter and contain only letters, numbers, dashes, and underscores.
 */
...
/*!
 Asynchronously subscribes the device to a channel of push notifications and
 calls the given block. Raises an exception if the current PFInstallation object
 is dirty.
 @param channel The channel to subscribe to. The channel name must start with
 a letter and contain only letters, numbers, dashes, and underscores.
 @param block The block to execute. The block should have the following argument signature: (BOOL succeeded, NSError *error) 
...
/*!
 Asynchronously subscribes the device to a channel of push notifications and
 calls the given callback. Raises an exception if the current PFInstallation
 object is dirty.
 @param channel The channel to subscribe to. The channel name must start with
 a letter and contain only letters, numbers, dashes, and underscores.
 @param target The object to call selector on.
...
/*!
 Unsubscribes the device to a channel of push notifications. Raises an exception
 if the current PFInstallation object is dirty.
...
/*!
 ...
 Raises an exception if the current PFInstallation object is dirty.
 @param channel The channel to unsubscribe from.
 */
...
/*!
 Asynchronously unsubscribes the device from a channel of push notifications and
 calls the given block. Raises an exception if the current PFInstallation object
 is dirty.
 @param channel The channel to unsubscribe from.
 @param block The block to execute. The block should have the following argument signature: (BOOL succeeded, NSError *error) 
